...
Write-Start "Installing Windows Terminal & Powershell..."
	...
	Start-BitsTransfer -Source "https://raw.githubusercontent.com/julianv22/install-structure/main/PowerShell/Microsoft.PowerShell_profile.ps1?token=GHSAT0AAAAAACKHBUXANYVRLQMRKQDF4HDGZLDM27A" -Destination $PROFILE
	. $PROFILE
Write-Done
